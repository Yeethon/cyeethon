...
class TestDiscovery(unittest.TestCase):
    ...
    def test_find_tests(self):
        ...
        expected = [
            [(name + " module tests")] for name in ("test1", "test2", "test_dir")
        ]
        expected.extend(
            [
                [(("test_dir.%s" % name) + " module tests")]
    ...
    def test_detect_module_clash(self):
        ...
        msg = re.escape(
            (
                "'foo' module incorrectly imported from %r. Expected %r. Is this module globally installed?"
