...
class Test_TestResult(unittest.TestCase):
    ...
    def testGetDescriptionWithoutDocstring(self):
        ...
        self.assertEqual(
            ...
            (("testGetDescriptionWithoutDocstring (" + __name__) + ".Test_TestResult)"),
        )
    ...
    def testGetSubTestDescriptionWithoutDocstringAndParams(self):
        with self.subTest():
            ...
            self.assertEqual(
                result.getDescription(self._subtest),
                (
                    ("testGetSubTestDescriptionWithoutDocstringAndParams (" + __name__)
        ...
        with self.subTest(foo=1):
            with self.subTest(baz=2, bar=3):
                ...
                self.assertEqual(
                    result.getDescription(self._subtest),
                    (
                        ("testGetNestedSubTestDescriptionWithoutDocstring (" + __name__)
    ...
    def testGetDescriptionWithOneLineDocstring(self):
        ...
        self.assertEqual(
            result.getDescription(self),
            (
                ("testGetDescriptionWithOneLineDocstring (" + __name__)
                + ".Test_TestResult)\nTests getDescription() for a method with a docstring."
            ),
        )
    ...
    def testGetSubTestDescriptionWithOneLineDocstring(self):
        ...
        with self.subTest(foo=1, bar=2):
            self.assertEqual(
                result.getDescription(self._subtest),
                (
                    ("testGetSubTestDescriptionWithOneLineDocstring (" + __name__)
                    + ".Test_TestResult) (foo=1, bar=2)\nTests getDescription() for a method with a docstring."
                ),
            )
    ...
    def testGetSubTestDescriptionWithMultiLineDocstring(self):
        ...
        with self.subTest(foo=1, bar=2):
            self.assertEqual(
                result.getDescription(self._subtest),
                (
                    ("testGetSubTestDescriptionWithMultiLineDocstring (" + __name__)
                    + ".Test_TestResult) (foo=1, bar=2)\nTests getDescription() for a method with a longer docstring."
                ),
            )
