...
class SimpleTypesTestCase(unittest.TestCase):
    ...
    def test_parameter_repr(self):
        ...
        self.assertRegex(
            repr(c_bool.from_param(True)), "^<cparam '\\?' at 0x[A-Fa-f0-9]+>$"
        )
        self.assertEqual(repr(c_char.from_param(97)), "<cparam 'c' ('a')>")
        self.assertRegex(
            repr(c_wchar.from_param("a")), "^<cparam 'u' at 0x[A-Fa-f0-9]+>$"
        )
        self.assertEqual(repr(c_byte.from_param(98)), "<cparam 'b' (98)>")
        self.assertEqual(repr(c_ubyte.from_param(98)), "<cparam 'B' (98)>")
        self.assertEqual(repr(c_short.from_param(511)), "<cparam 'h' (511)>")
        self.assertEqual(repr(c_ushort.from_param(511)), "<cparam 'H' (511)>")
        self.assertRegex(repr(c_int.from_param(20000)), "^<cparam '[li]' \\(20000\\)>$")
        self.assertRegex(
            repr(c_uint.from_param(20000)), "^<cparam '[LI]' \\(20000\\)>$"
        )
        self.assertRegex(
            repr(c_long.from_param(20000)), "^<cparam '[li]' \\(20000\\)>$"
        )
        self.assertRegex(
            repr(c_ulong.from_param(20000)), "^<cparam '[LI]' \\(20000\\)>$"
        )
        self.assertRegex(
            repr(c_longlong.from_param(20000)), "^<cparam '[liq]' \\(20000\\)>$"
        )
        self.assertRegex(
            repr(c_ulonglong.from_param(20000)), "^<cparam '[LIQ]' \\(20000\\)>$"
        )
        ...
        self.assertRegex(
            ...
            "^<cparam ('d' \\(1.5\\)|'g' at 0x[A-Fa-f0-9]+)>$",
        )
        self.assertRegex(
            repr(c_char_p.from_param(b"hihi")), "^<cparam 'z' \\(0x[A-Fa-f0-9]+\\)>$"
        )
        self.assertRegex(
            repr(c_wchar_p.from_param("hihi")), "^<cparam 'Z' \\(0x[A-Fa-f0-9]+\\)>$"
        )
        self.assertRegex(repr(c_void_p.from_param(18)), "^<cparam 'P' \\(0x0*12\\)>$")
