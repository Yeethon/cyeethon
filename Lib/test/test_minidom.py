...
def create_nonempty_doctype():
    ...
    notation = xml.dom.minidom.Notation(
        "my-notation", None, "http://xml.python.org/notations/my"
    )
    doctype.notations._seq.append(notation)
    entity = xml.dom.minidom.Entity(
        "my-entity", None, "http://xml.python.org/entities/my", "my-notation"
    )
    entity.version = "1.0"
...
class MinidomTest(unittest.TestCase):
    ...
    def testInsertBeforeFragment(self):
        ...
        self.confirm(
            (tuple(dom.documentElement.childNodes) == (c1, c2, c3, orig)),
    ...
    def testReplaceChildFragment(self):
        ...
        orig.unlink()
        self.confirm(
            (tuple(dom.documentElement.childNodes) == (c1, c2, c3)),
    ...
    def testNamedNodeMapSetItem(self):
        ...
        a = attrs.item(0)
        self.confirm(
            (a.ownerDocument is dom), "NamedNodeMap.__setitem__() sets ownerDocument"
        )
        self.confirm(
            (a.ownerElement is elem), "NamedNodeMap.__setitem__() sets ownerElement"
        )
        self.confirm((a.value == "bar"), "NamedNodeMap.__setitem__() sets value")
        self.confirm(
            (a.nodeValue == "bar"), "NamedNodeMap.__setitem__() sets nodeValue"
        )
        elem.unlink()
        dom.unlink()
    ...
    def testAAA(self):
        ...
        self.confirm(
            (a.ownerElement is dom.documentElement), "setAttribute() sets ownerElement"
        )
        dom.unlink()
    ...
    def testRemoveAttrNS(self):
        ...
        self.assertRaises(
            xml.dom.NotFoundErr, child.removeAttributeNS, "foo", "http://www.python.org"
        )
        self.confirm((len(child.attributes) == 2))
    ...
    def testGetAttributeNS(self):
        ...
        self.assertEqual(
            child.getAttributeNS("http://www.w3.org", "python"), "http://www.python.org"
        )
    ...
    def test_toprettyxml_with_text_nodes(self):
        ...
        self.assertEqual(
            parseString("<C>A<B>A</B></C>").toprettyxml(),
            (decl + "<C>\n\tA\n\t<B>A</B>\n</C>\n"),
        )
        self.assertEqual(
            parseString("<C><B>A</B>A</C>").toprettyxml(),
            (decl + "<C>\n\t<B>A</B>\n\tA\n</C>\n"),
        )
        self.assertEqual(
            parseString("<C><B>A</B><B>A</B></C>").toprettyxml(),
            (decl + "<C>\n\t<B>A</B>\n\t<B>A</B>\n</C>\n"),
        )
        self.assertEqual(
            parseString("<C><B>A</B>A<B>A</B></C>").toprettyxml(),
            (decl + "<C>\n\t<B>A</B>\n\tA\n\t<B>A</B>\n</C>\n"),
        )
    ...
    def testRemoveNamedItemNS(self):
        ...
        self.confirm(a1.isSameNode(a2))
        self.assertRaises(
            xml.dom.NotFoundErr, attrs.removeNamedItemNS, "http://xml.python.org/", "b"
        )
    ...
    def _testCloneElementCopiesAttributes(self, e1, e2, test):
        ...
        for i in range(len(keys1)):
            ...
            self.confirm(
                (a2.ownerElement is e2), "clone of attribute node correctly owned"
            )
    ...
    def check_clone_attribute(self, deep, testName):
        ...
        self.confirm(
            (clone.ownerElement is None), (testName + ": ownerElement should be None")
        )
        self.confirm(
            clone.ownerDocument.isSameNode(attr.ownerDocument),
    ...
    def check_clone_node_entity(self, clone_document):
        ...
        if clone_document:
            ...
            self.assertEqual(
                clone.documentElement.firstChild.wholeText,
    ...
    def testNormalize(self):
        ...
        self.confirm(
            ((len(root.childNodes) == 2) and (root.childNodes.length == 2)),
        ...
        doc.normalize()
        self.confirm(
            ((len(root.childNodes) == 0) and (root.childNodes.length == 0)),
    ...
    def testNormalizeCombineAndNextSibling(self):
        ...
        self.confirm(
            ((len(root.childNodes) == 3) and (root.childNodes.length == 3)),
    ...
    def testNormalizeDeleteAndCombine(self):
        ...
        root.appendChild(doc.createTextNode(""))
        self.confirm(
            ((len(root.childNodes) == 5) and (root.childNodes.length == 5)),
    ...
    def testNormalizeRecursion(self):
        ...
        self.confirm(
            (
                (root.childNodes[0].childNodes[1].data == "tx")
    ...
    def testBug1433694(self):
        ...
        node.normalize()
        self.confirm(
            (node.childNodes[(-1)].nextSibling is None),
    ...
    def testSiblings(self):
        ...
        self.confirm(
            (
                (pi.nextSibling is text)
                and (pi.previousSibling is None)
                and (text.nextSibling is elm)
                and (text.previousSibling is pi)
                and (elm.nextSibling is None)
                and (elm.previousSibling is text)
            ),
            "testSiblings",
        )
        doc.unlink()
    ...
    def testParents(self):
        ...
        self.confirm(
            (
                (root.parentNode is doc)
                and (elm1.parentNode is root)
                and (elm2a.parentNode is elm1)
                and (elm2b.parentNode is elm1)
                and (elm3.parentNode is elm2b)
            ),
            "testParents",
        )
        doc.unlink()
    ...
    def testStandalone(self):
        ...
        self.assertEqual(doc.toxml(), '<?xml version="1.0" ?><foo>€</foo>')
        self.assertEqual(
            doc.toxml(standalone=None), '<?xml version="1.0" ?><foo>€</foo>'
        )
        self.assertEqual(
            doc.toxml(standalone=True),
            '<?xml version="1.0" standalone="yes"?><foo>€</foo>',
        )
        self.assertEqual(
            doc.toxml(standalone=False),
            '<?xml version="1.0" standalone="no"?><foo>€</foo>',
        )
        self.assertEqual(
            doc.toxml("utf-8", True),
            b'<?xml version="1.0" encoding="utf-8" standalone="yes"?><foo>\xe2\x82\xac</foo>',
        )
        doc.unlink()
    ...
    def testRenameAttribute(self):
        ...
        self.confirm(
            (
                ...
                and elem.getAttributeNodeNS("http://xml.python.org/ns", "c").isSameNode(
                    attr
                )
        ...
        self.confirm(
            (
                ...
                and (elem.getAttributeNodeNS("http://xml.python.org/ns", "c") is None)
                and elem.getAttributeNode("p:d").isSameNode(attr)
                and elem.getAttributeNodeNS(
                    "http://xml.python.org/ns2", "d"
                ).isSameNode(attr)
    ...
    def testSchemaType(self):
        ...
        for name in names:
            ...
            t = a.schemaType
            self.confirm(
                (hasattr(t, "name") and (t.namespace == xml.dom.EMPTY_NAMESPACE))
            )
    ...
    def testSetIdAttribute(self):
        ...
        self.confirm(
            ((doc.getElementById("v") is None) and (not a1.isId) and (not a2.isId))
        )
        e.setIdAttribute("a1")
        self.confirm(
            (e.isSameNode(doc.getElementById("v")) and a1.isId and (not a2.isId))
        )
        e.setIdAttribute("a2")
        self.confirm(
            (
                e.isSameNode(doc.getElementById("v"))
    ...
    def testSetIdAttributeNS(self):
        ...
        doc = parseString(
            (
                ((("<doc xmlns:ns1='" + NS1) + "' xmlns:ns2='") + NS2)
                + "' ns1:a1='v' ns2:a2='w'/>"
            )
        )
        e = doc.documentElement
