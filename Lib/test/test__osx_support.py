...
class Test_OSXSupport(unittest.TestCase):
    ...
    def test__get_system_version(self):
        self.assertTrue(
            platform.mac_ver()[0].startswith(_osx_support._get_system_version())
        )
    ...
    def test__supports_universal_builds(self):
        ...
        self.assertEqual(
            (mac_ver_tuple >= (10, 4)), _osx_support._supports_universal_builds()
        )
    ...
    def test__find_appropriate_compiler(self):
        ...
        config_vars = {
            ...
            "LDSHARED": "gcc-test -bundle -arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -g",
        }
        expected_vars = {
            "CC": "clang -pthreads",
            "CXX": "clang++",
            ...
            "LDSHARED": "clang -bundle -arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -g",
        }
        self.add_expected_saved_initial_values(config_vars, expected_vars)
    ...
    def test__remove_universal_flags(self):
        config_vars = {
            ...
            "LDSHARED": "gcc-4.0 -bundle  -arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -g",
        }
        expected_vars = {
        ...
        self.add_expected_saved_initial_values(config_vars, expected_vars)
        self.assertEqual(
            expected_vars, _osx_support._remove_universal_flags(config_vars)
        )
    ...
    def test__remove_unsupported_archs(self):
        ...
        expected_vars = {
            ...
            "LDSHARED": "gcc-4.0 -bundle   -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -g",
        }
        self.add_expected_saved_initial_values(config_vars, expected_vars)
        suffix = (":" + self.env["PATH"]) if self.env["PATH"] else ""
        self.env["PATH"] = os.path.abspath(self.temp_path_dir) + suffix
    ...
    def test__override_all_archs(self):
        ...
        expected_vars = {
            ...
            "LDSHARED": "gcc-4.0 -bundle   -isysroot /Developer/SDKs/MacOSX10.4u.sdk -g -arch x86_64",
        }
        self.add_expected_saved_initial_values(config_vars, expected_vars)
    ...
    def test__check_for_unavailable_sdk(self):
        config_vars = {
            "CC": "clang",
            "CFLAGS": "-fno-strict-aliasing  -g -O3 -arch ppc -arch i386  -isysroot /Developer/SDKs/MacOSX10.1.sdk",
            "LDFLAGS": "-arch ppc -arch i386   -g",
            "CPPFLAGS": "-I. -isysroot /Developer/SDKs/MacOSX10.1.sdk",
            "BLDSHARED": "gcc-4.0 -bundle  -arch ppc -arch i386 -g",
            "LDSHARED": "gcc-4.0 -bundle  -arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.1.sdk -g",
        }
        expected_vars = {
            "CC": "clang",
            "CFLAGS": "-fno-strict-aliasing  -g -O3 -arch ppc -arch i386   ",
