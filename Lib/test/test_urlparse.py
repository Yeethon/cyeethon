...
class UrlParseTestCase(unittest.TestCase):
    ...
    def test_withoutscheme(self):
        ...
        self.assertEqual(
            urllib.parse.urlparse("//www.python.org:80"),
            ("", "www.python.org:80", "", "", "", ""),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            urllib.parse.urlparse(b"path"), (b"", b"", b"path", b"", b"", b"")
        )
        self.assertEqual(
    ...
    def test_portseparator(self):
        self.assertEqual(
            urllib.parse.urlparse("http:80"), ("http", "", "80", "", "", "")
        )
        self.assertEqual(
            urllib.parse.urlparse("https:80"), ("https", "", "80", "", "", "")
        )
        self.assertEqual(
            urllib.parse.urlparse("path:80"), ("path", "", "80", "", "", "")
        )
        ...
        self.assertEqual(
            urllib.parse.urlparse(b"http:80"), (b"http", b"", b"80", b"", b"", b"")
        )
        self.assertEqual(
            urllib.parse.urlparse(b"https:80"), (b"https", b"", b"80", b"", b"", b"")
        )
        self.assertEqual(
            urllib.parse.urlparse(b"path:80"), (b"path", b"", b"80", b"", b"", b"")
        )
        self.assertEqual(
            urllib.parse.urlparse(b"http:"), (b"http", b"", b"", b"", b"", b"")
        )
        self.assertEqual(
            urllib.parse.urlparse(b"https:"), (b"https", b"", b"", b"", b"", b"")
        )
        self.assertEqual(
            urllib.parse.urlparse(b"http://www.python.org:80"),
            (b"http", b"www.python.org:80", b"", b"", b"", b""),
    ...
    def test_anyscheme(self):
        self.assertEqual(
            urllib.parse.urlparse("s3://foo.com/stuff"),
            ("s3", "foo.com", "/stuff", "", "", ""),
        )
        self.assertEqual(
    ...
    def test_urlencode_quote_via(self):
        ...
        result = urllib.parse.urlencode(
            {"a": "some value/another"}, quote_via=urllib.parse.quote
        )
        self.assertEqual(result, "a=some%20value%2Fanother")
        result = urllib.parse.urlencode(
            {"a": "some value/another"}, safe="/", quote_via=urllib.parse.quote
        )
    ...
    def test_urlsplit_normalization(self):
        ...
        denorm_chars = [
            ...
            if (
                (hex_chars & set(unicodedata.decomposition(c).split()))
...
class Utility_Tests(unittest.TestCase):
    ...
    def test_splithost(self):
        ...
        self.assertEqual(
            splithost("//127.0.0.1#@host.com"), ("127.0.0.1", "/#@host.com")
        )
        self.assertEqual(
            splithost("//127.0.0.1#@host.com:80"), ("127.0.0.1", "/#@host.com:80")
        )
        self.assertEqual(
            splithost("//127.0.0.1:80#@host.com"), ("127.0.0.1:80", "/#@host.com")
        )
    ...
    def test_splituser(self):
        ...
        self.assertEqual(
            splituser("User@example.com:Pass@www.python.org:080"),
    ...
    def test_splitquery(self):
        ...
        self.assertEqual(
            splitquery("http://python.org/fake?foo=bar"),
        ...
        self.assertEqual(
            splitquery("http://python.org/fake"), ("http://python.org/fake", None)
        )
    ...
    def test_splittag(self):
        ...
        self.assertEqual(
            splittag("http://example.com?foo=bar#baz"),
            ("http://example.com?foo=bar", "baz"),
        )
        self.assertEqual(
            splittag("http://example.com?foo=bar#"), ("http://example.com?foo=bar", "")
        )
        self.assertEqual(splittag("#baz"), ("", "baz"))
        self.assertEqual(
            splittag("http://example.com?foo=bar"), ("http://example.com?foo=bar", None)
        )
        self.assertEqual(
            splittag("http://example.com?foo=bar#baz#boo"),
    ...
    def test_splitattr(self):
        ...
        self.assertEqual(
            splitattr(";attr1=value1;attr2=value2"),
    ...
    def test_to_bytes(self):
        ...
        self.assertRaises(
            UnicodeError, urllib.parse._to_bytes, "http://www.python.org/mediæval"
        )
...
class DeprecationTest(unittest.TestCase):
    ...
    def test_to_bytes_deprecation(self):
        ...
        self.assertEqual(
            str(cm.warning), "urllib.parse.to_bytes() is deprecated as of 3.8"
        )
