...
class PosixPathTest(unittest.TestCase):
    ...
    def splitextTest(self, path, filename, ext):
        ...
        self.assertEqual(posixpath.splitext(("/" + path)), (("/" + filename), ext))
        self.assertEqual(
            posixpath.splitext(("abc/" + path)), (("abc/" + filename), ext)
        )
        self.assertEqual(
        ...
        self.assertEqual(
            posixpath.splitext((path + "/")), (((filename + ext) + "/"), "")
        )
        ...
        self.assertEqual(
            posixpath.splitext((b"abc/" + path)), ((b"abc/" + filename), ext)
        )
        self.assertEqual(
        ...
        self.assertEqual(
            posixpath.splitext((path + b"/")), (((filename + ext) + b"/"), b"")
        )
    ...
    def test_islink(self):
        ...
        self.assertIs(
            posixpath.islink((os.fsencode(os_helper.TESTFN) + b"\xff")), False
        )
        self.assertIs(posixpath.islink((os_helper.TESTFN + "\x00")), False)
        self.assertIs(
            posixpath.islink((os.fsencode(os_helper.TESTFN) + b"\x00")), False
        )
    ...
    def test_normpath(self):
        ...
        self.assertEqual(
            posixpath.normpath(b"///foo/.//bar//.//..//.//baz"), b"/foo/baz"
        )
        self.assertEqual(posixpath.normpath(b"///..//./foo/.//bar"), b"/foo/bar")
    ...
    def test_relpath(self):
        ...
        try:
            ...
            self.assertEqual(
                posixpath.relpath("a/b", "../c"), (("../" + curdir) + "/a/b")
            )
    ...
    def test_relpath_bytes(self):
        ...
        try:
            ...
            self.assertEqual(posixpath.relpath(b"../a/b"), b"../a/b")
            self.assertEqual(
                posixpath.relpath(b"a", b"../b"), ((b"../" + curdir) + b"/a")
            )
            self.assertEqual(
