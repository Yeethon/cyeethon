...
class TestVectorsTestCase(unittest.TestCase):
    ...
    def _rfc4231_test_cases(self, hashfunc, hash_name, digest_size, block_size):
        ...
        hmactest(
            ...
            data=b"Hi There",
            hexdigests={
                hashlib.sha224: "896fb1128abbdf196832107cd49df33f47b4b1169912ba4f53684b22",
        ...
        hmactest(
            ...
            hexdigests={
                hashlib.sha224: "a30e01098bc6dbbf45690f3a7e9e6d0f8bbea2a39e6148008fd05e44",
        ...
        hmactest(
            ...
            data=(b"\xdd" * 50),
            hexdigests={
                hashlib.sha224: "7fb3cb3588c6c1f6ffa9694d7d6ad2649365b0c1f65d69d1ec8333ea",
        ...
        hmactest(
            key=bytes((x for x in range(1, (25 + 1)))),
            data=(b"\xcd" * 50),
            hexdigests={
                hashlib.sha224: "6c11506874013cac6a2abc1bb382627cec6a90d86efc012de7afec5a",
        ...
        hmactest(
            ...
            hexdigests={
                hashlib.sha224: "95e9a0db962095adaebe9b2d6f0dbce2d499f112f2d2b7273fa6870e",
        ...
        hmactest(
            ...
            hexdigests={
                hashlib.sha224: "3a854166ac5d9f023f54d517d0b39dbd946770db9c2b95c9f6f565d1",
...
class ConstructorTestCase(unittest.TestCase):
    ...
    def test_internal_types(self):
        with self.assertRaisesRegex(TypeError, "cannot create 'HMAC' instance"):
            C_HMAC()
