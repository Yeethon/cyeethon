...
class CookieTests(unittest.TestCase):
    ...
    def test_load(self):
        ...
        self.assertEqual(
            C.output(["path"]), 'Set-Cookie: Customer="WILE_E_COYOTE"; Path=/acme'
        )
        self.assertEqual(
            C.js_output(),
    ...
    def test_extended_encode(self):
        ...
        self.assertEqual(
            C.output(["val"]), 'Set-Cookie: val="some\\054funky\\073stuff"'
        )
    ...
    def test_set_secure_httponly_attrs(self):
        ...
        self.assertEqual(
            C.output(), 'Set-Cookie: Customer="WILE_E_COYOTE"; HttpOnly; Secure'
        )
    ...
    def test_comment_quoting(self):
        ...
        self.assertEqual(
            str(c["foo"]), 'Set-Cookie: foo="\\251"; Comment="comment \\251"'
        )
