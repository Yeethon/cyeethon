...
class TestEmailMessageBase:
    ...
    def _make_subtype_test_message(self, subtype):
        m = self.message()
        payload = None
        msg_headers = [("To", "foo@bar.com"), ("From", "bar@foo.com")]
    ...
    def _check_make_multipart(self, m, msg_headers, payload):
        ...
        for (name, value) in msg_headers:
            if not name.lower().startswith("content-"):
                ...
                count += 1
        self.assertEqual(len(m), (count + 1))
    ...
    def message_as_clear_content(self, body_parts, attachments, parts, msg):
        m = self._str_msg(msg)
        expected_headers = [
            h for h in m.keys() if (not h.lower().startswith("content-"))
        ]
        m.clear_content()
...
class TestEmailMessage(TestEmailMessageBase, TestEmailBase):
    ...
    def test_folding_with_utf8_encoding_2(self):
        ...
        self.assertEqual(
            bytes(m),
            b"Subject: Hello =?utf-8?q?W=C3=B6rld!_Hello_W=C3=B6rld!_Hello_W=C3=B6rlds123!?=\n Hello =?utf-8?q?W=C3=B6rld!Hello_W=C3=B6rld!?=\n\n",
        )
    ...
    def test_folding_with_utf8_encoding_3(self):
        ...
        self.assertEqual(
            bytes(m),
            b"Subject: =?utf-8?q?Hello-W=C3=B6rld!-Hello-W=C3=B6rld!-Hello-W=C3=B6rlds123!?=\n Hello =?utf-8?q?W=C3=B6rld!Hello_W=C3=B6rld!?=\n\n",
        )
    ...
    def test_folding_with_utf8_encoding_5(self):
        ...
        m[
            "Subject"
        ] = "123456789 123456789 123456789 123456789 123456789 123456789 123456789 Hello Wörld!"
        self.assertEqual(
            bytes(m),
            b"Subject: 123456789 123456789 123456789 123456789 123456789 123456789 123456789\n Hello =?utf-8?q?W=C3=B6rld!?=\n\n",
        )
    ...
    def test_folding_with_utf8_encoding_6(self):
        ...
        m[
            "Subject"
        ] = "123456789 123456789 123456789 123456789 Hello Wörld! 123456789 123456789 123456789 123456789 123456789 123456789"
        self.assertEqual(
            bytes(m),
            b"Subject: 123456789 123456789 123456789 123456789 Hello =?utf-8?q?W=C3=B6rld!?=\n 123456789 123456789 123456789 123456789 123456789 123456789\n\n",
        )
    ...
    def test_folding_with_utf8_encoding_7(self):
        ...
        m[
            "Subject"
        ] = "123456789 123456789 Hello Wörld! Hello Wörld! 123456789-123456789 123456789 Hello Wörld! 123456789 123456789"
        self.assertEqual(
            bytes(m),
            b"Subject: 123456789 123456789 Hello =?utf-8?q?W=C3=B6rld!_Hello_W=C3=B6rld!?=\n 123456789-123456789 123456789 Hello =?utf-8?q?W=C3=B6rld!?= 123456789\n 123456789\n\n",
        )
    ...
    def test_folding_with_utf8_encoding_8(self):
        ...
        m[
            "Subject"
        ] = "123456789 123456789 Hello Wörld! Hello Wörld! 123456789 123456789 123456789 123456789 123456789 123456789-123456789 123456789 Hello Wörld! 123456789 123456789"
        self.assertEqual(
            bytes(m),
