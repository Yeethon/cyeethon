...
class XmlgenTest:
    ...
    def test_5027_1(self):
        test_xml = StringIO(
            '<?xml version="1.0"?><a:g1 xmlns:a="http://example.com/ns"><a:g2 xml:lang="en">Hello</a:g2></a:g1>'
        )
        parser = make_parser()
...
class ExpatReaderTest(XmlTestBase):
    ...
    def test_expat_nsattrs_wattr(self):
        ...
        self.assertTrue(
            ((attrs.getQNames() == []) or (attrs.getQNames() == ["ns:attr"]))
        )
        self.assertEqual(len(attrs), 1)
...
class CDATAHandlerTest(unittest.TestCase):
    def setUp(self):
        ...
        self.test_data.write(
            f"""{self.specified_chars[0][0]}
"""
        )
        self.test_data.write("</some_pcdata>\n")
        self.test_data.write("<some_cdata>\n")
        self.test_data.write(
            f"""<![CDATA[{self.specified_chars[1][0]}]]>
"""
        )
        self.test_data.write("</some_cdata>\n")
        self.test_data.write("</root_doc>\n")
