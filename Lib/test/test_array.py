...
class ArrayReconstructorTest(unittest.TestCase):
    ...
    def test_numbers(self):
        testcases = (
            (["B", "H", "I", "L"], UNSIGNED_INT8, "=BBBB", [128, 127, 0, 255]),
            (["b", "h", "i", "l"], SIGNED_INT8, "=bbb", [(-128), 127, 0]),
            (["H", "I", "L"], UNSIGNED_INT16_LE, "<HHHH", [32768, 32767, 0, 65535]),
            (["H", "I", "L"], UNSIGNED_INT16_BE, ">HHHH", [32768, 32767, 0, 65535]),
            (["h", "i", "l"], SIGNED_INT16_LE, "<hhh", [(-32768), 32767, 0]),
            (["h", "i", "l"], SIGNED_INT16_BE, ">hhh", [(-32768), 32767, 0]),
            (
                ["I", "L"],
                UNSIGNED_INT32_LE,
                "<IIII",
