...
class TestSysConfig(unittest.TestCase):
    ...
    def test_get_platform(self):
        ...
        get_config_vars()[
            "CFLAGS"
        ] = "-arch x86_64 -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk  -fno-strict-aliasing -fno-common -dynamic -DNDEBUG -g -O3"
        self.assertEqual(get_platform(), "macosx-10.4-intel")
        _osx_support._remove_original_values(get_config_vars())
        get_config_vars()[
            "CFLAGS"
        ] = "-arch x86_64 -arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk  -fno-strict-aliasing -fno-common -dynamic -DNDEBUG -g -O3"
        self.assertEqual(get_platform(), "macosx-10.4-fat3")
        _osx_support._remove_original_values(get_config_vars())
        get_config_vars()[
            "CFLAGS"
        ] = "-arch ppc64 -arch x86_64 -arch ppc -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk  -fno-strict-aliasing -fno-common -dynamic -DNDEBUG -g -O3"
        self.assertEqual(get_platform(), "macosx-10.4-universal")
        _osx_support._remove_original_values(get_config_vars())
        get_config_vars()[
            "CFLAGS"
        ] = "-arch x86_64 -arch ppc64 -isysroot /Developer/SDKs/MacOSX10.4u.sdk  -fno-strict-aliasing -fno-common -dynamic -DNDEBUG -g -O3"
        self.assertEqual(get_platform(), "macosx-10.4-fat64")
        for arch in ("ppc", "i386", "x86_64", "ppc64"):
            _osx_support._remove_original_values(get_config_vars())
            get_config_vars()["CFLAGS"] = (
                "-arch %s -isysroot /Developer/SDKs/MacOSX10.4u.sdk  -fno-strict-aliasing -fno-common -dynamic -DNDEBUG -g -O3"
                % arch
            )
    ...
    @unittest.skipUnless(
        ((sys.platform == "linux") and hasattr(sys.implementation, "_multiarch")),
