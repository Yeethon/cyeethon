...
class BuiltinTest(unittest.TestCase):
    ...
    def test_filter(self):
        ...
        self.assertEqual(
            list(filter((lambda x: (x > 0)), [1, (-3), 9, 0, 2])), [1, 9, 2]
        )
        self.assertEqual(
            list(filter(None, Squares(10))), [1, 4, 9, 16, 25, 36, 49, 64, 81]
        )
        self.assertEqual(
            list(filter((lambda x: (x % 2)), Squares(10))), [1, 9, 25, 49, 81]
        )
    ...
    def test_map(self):
        ...
        self.assertEqual(
            list(map(plus, [1, 3, 7], [4, 9, 2])), [(1 + 4), (3 + 9), (7 + 2)]
        )
        self.assertEqual(
    ...
    def test_sum(self):
        ...
        self.assertEqual(
            sum((((i % 2) != 0) for i in range(10)), ((2 ** 31) - 3)), ((2 ** 31) + 2)
        )
        self.assertEqual(
            sum((((i % 2) != 0) for i in range(10)), ((2 ** 63) - 3)), ((2 ** 63) + 2)
        )
    ...
    def test_format(self):
        ...
        for cls in [object, B, C]:
            ...
            self.assertEqual(format(obj, ""), str(obj))
            with self.assertRaisesRegex(
                TypeError, ("\\b%s\\b" % re.escape(cls.__name__))
            ):
                format(obj, "s")
