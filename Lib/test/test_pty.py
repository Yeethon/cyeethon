    ...
    def setUp(self):
        ...
        if _HAVE_WINSZ:
            try:
                ...
                old_stdin_winsz = struct.pack(
                    "HHHH", self.stdin_rows, self.stdin_cols, 0, 0
                )
    ...
    def test_openpty(self):
        ...
        if (self.stdin_rows != None) and (self.stdin_cols != None):
            try:
                ...
                target_stdin_winsz = struct.pack(
                    "HHHH", target_stdin_rows, target_stdin_cols, 0, 0
                )
