...
class Test_IncrementalEncoder(unittest.TestCase):
    def test_stateless(self):
        ...
        self.assertEqual(
            encoder.encode("파이썬 마을"), b"\xc6\xc4\xc0\xcc\xbd\xe3 \xb8\xb6\xc0\xbb"
        )
    ...
    def test_getstate_returns_expected_value(self):
        ...
        self.assertEqual(
            ...
            int.from_bytes(b"\x00BB\x00\x00\x00\x00\x00\x00", "little"),
        )
        non_buffer_state_encoder.encode("あ")
        self.assertEqual(
            non_buffer_state_encoder.getstate(),
            int.from_bytes(b"\x00\xc2B\x00\x00\x00\x00\x00\x00", "little"),
        )
