...
class Regrtest:
    ...
    def get_executed(self):
        return (
            (
                ((set(self.good) | set(self.bad)) | set(self.skipped))
    ...
    def parse_args(self, kwargs):
        ...
        if ns.huntrleaks:
            ...
            if (warmup < 1) or (repetitions < 1):
                msg = "Invalid values for the --huntrleaks/-R parameters. The number of warmups and repetitions must be at least 1 each (1:1)."
    ...
    def run_tests_sequential(self):
        ...
        for (test_index, test_name) in enumerate(self.tests, 1):
            ...
            if self.tracer:
                cmd = "result = runtest(self.ns, test_name); self.accumulate_result(result)"
                ns = dict(locals())
    ...
    def run_tests(self):
        ...
        if self.ns.huntrleaks:
            ...
            if warmup < 3:
                msg = "WARNING: Running tests with --huntrleaks/-R and less than 3 warmup repetitions can give false positives!"
