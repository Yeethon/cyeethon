...
class ComplexTest(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertAlmostEqual(
            complex(real=float2(17.0), imag=float2(23.0)), (17 + 23j)
        )
    ...
    def test_abs(self):
        ...
        for num in nums:
            self.assertAlmostEqual(
                (((num.real ** 2) + (num.imag ** 2)) ** 0.5), abs(num)
            )
    ...
    def test_repr_roundtrip(self):
        vals = [0.0, 0.0, 1e-315, 1e-200, 0.0123, 3.1415, 1e50, INF, NAN]
    ...
    def test_format(self):
        ...
        self.assertEqual(format(((-1.5) - 3.5j), ".2E"), "-1.50E+00-3.50E+00j")
        self.assertEqual(
            format(((-15000000000.0) - 350000j), ".2G"), "-1.5E+10-3.5E+05j"
        )
