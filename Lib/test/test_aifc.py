...
class AifcPCM8Test(AifcTest, unittest.TestCase):
    ...
    frames = bytes.fromhex(
        "      02FF 4B00 3104 8008 CB06 4803 BF01 03FE B8FA B4F3 29EB 1AE6       EDE4 C6E2 0EE0 EFE0 57E2 FBE8 13EF D8F7 97FB F5FC 08FB DFFB       11FA 3EFB BCFC 66FF CF04 4309 C10E 5112 EE17 8216 7F14 8012       490E 520D EF0F CE0F E40C 630A 080A 2B0B 510E 8B11 B60E 440A       "
    )
...
class AIFCLowLevelTest(unittest.TestCase):
    ...
    def test_read_no_ssnd_chunk(self):
        ...
        b += b"COMM" + struct.pack(
            ">LhlhhLL", 38, 1, 0, 8, (16384 | 12), (11025 << 18), 0
        )
    ...
    def test_read_wrong_compression_type(self):
        b = (b"FORM" + struct.pack(">L", 4)) + b"AIFC"
        b += b"COMM" + struct.pack(
            ">LhlhhLL", 23, 1, 0, 8, (16384 | 12), (11025 << 18), 0
        )
    ...
    def test_read_wrong_number_of_channels(self):
        for nchannels in (0, (-1)):
            b = (b"FORM" + struct.pack(">L", 4)) + b"AIFC"
            b += b"COMM" + struct.pack(
                ">LhlhhLL", 38, nchannels, 0, 8, (16384 | 12), (11025 << 18), 0
            )
            b += ((b"NONE" + struct.pack("B", 14)) + b"not compressed") + b"\x00"
    ...
    def test_read_wrong_sample_width(self):
        for sampwidth in (0, (-1)):
            b = (b"FORM" + struct.pack(">L", 4)) + b"AIFC"
            b += b"COMM" + struct.pack(
                ">LhlhhLL", 38, 1, 0, sampwidth, (16384 | 12), (11025 << 18), 0
            )
            b += ((b"NONE" + struct.pack("B", 14)) + b"not compressed") + b"\x00"
            b += (b"SSND" + struct.pack(">L", 8)) + (b"\x00" * 8)
    ...
    def test_read_wrong_marks(self):
        ...
        b += b"COMM" + struct.pack(
            ">LhlhhLL", 18, 1, 0, 8, (16384 | 12), (11025 << 18), 0
        )
        b += (b"SSND" + struct.pack(">L", 8)) + (b"\x00" * 8)
        ...
        self.assertEqual(
            str(cm.warning), "Warning: MARK chunk contains only 0 markers instead of 1"
        )
