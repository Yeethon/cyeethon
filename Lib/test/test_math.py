...
class MathTests(unittest.TestCase):
    ...
    def testFsum(self):
        ...
        def msum(iterable):
            ...
            if tail > 0:
                h = 1 << (tail - 1)
                tmant = (tmant // (2 * h)) + bool(
                    ((tmant & h) and (tmant & ((3 * h) - 1)))
                )
                texp += tail
        ...
        test_values = [
            ...
            ([1e16, 1.0, 1e-16], 1.0000000000000002e16),
            (
                [
                    (1e16 - 2.0),
                    (1.0 - (2.0 ** (-53))),
    ...
    def testHypot(self):
        ...
        self.assertEqual(hypot(0.0, 0.0), 0.0)
        self.assertEqual(hypot((-10.5)), 10.5)
        self.assertEqual(hypot(), 0.0)
        self.assertEqual(1.0, math.copysign(1.0, hypot((-0.0))))
        self.assertEqual(hypot(1.5, 1.5, 0.5), hypot(1.5, 0.5, 1.5))
    ...
    def testDist(self):
        ...
        self.assertEqual(
            dist((F(14, 32), F(1, 32)), (F(2, 32), F((-4), 32))), F(13, 32)
        )
        self.assertEqual(
            dist((True, True, False, True, False), (True, False, True, True, False)),
            sqrt(2.0),
        )
        self.assertEqual(dist((13.25, 12.5, (-3.25)), (13.25, 12.5, (-3.25))), 0.0)
        self.assertEqual(dist((), ()), 0.0)
        self.assertEqual(1.0, math.copysign(1.0, dist(((-0.0),), (0.0,))))
        self.assertEqual(1.0, math.copysign(1.0, dist((0.0,), ((-0.0),))))
        self.assertEqual(
    ...
    def testIsqrt(self):
        test_values = (
            (list(range(1000)) + list(range(((10 ** 6) - 1000), ((10 ** 6) + 1000))))
    ...
    def testSinh(self):
        ...
        self.ftest(
            "sinh(1)**2-cosh(1)**2", ((math.sinh(1) ** 2) - (math.cosh(1) ** 2)), (-1)
        )
    ...
    def testTanhSign(self):
        ...
        self.assertEqual(
            math.copysign(1.0, math.tanh((-0.0))), math.copysign(1.0, (-0.0))
        )
    ...
    def testIsinf(self):
        ...
        self.assertTrue(math.isinf(float("-inf")))
        self.assertTrue(math.isinf(1e309))
        self.assertTrue(math.isinf((-1e309)))
    ...
    def testPerm(self):
        ...
        for n in range(1, 100):
            for k in range(1, n):
                self.assertEqual(
                    perm(n, k), ((perm((n - 1), (k - 1)) * k) + perm((n - 1), k))
                )
        for n in range(1, 100):
    ...
    def test_nextafter(self):
        ...
        self.assertEqual(
            math.nextafter(9.223372036854776e18, 0.0), 9.223372036854775e18
        )
        self.assertEqual(
            math.nextafter((-9.223372036854776e18), 0.0), (-9.223372036854775e18)
        )
