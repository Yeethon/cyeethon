...
cET_alias = import_fresh_module(
    "xml.etree.cElementTree", fresh=["_elementtree", "xml.etree"], deprecated=True
)
...
def test_main():
    ...
    support.run_unittest(
        MiscTests, TestAliasWorking, TestAcceleratorImported, SizeofTest
    )
