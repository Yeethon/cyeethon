...
class Test_GB18030(multibytecodec_support.TestBase, unittest.TestCase):
    ...
    codectests = (
        ...
        (b"abc\x80\x80\xc1\xc4\xc8", "replace", "abc��聊�"),
        (b"abc\x80\x80\xc1\xc4", "ignore", "abc聊"),
        (b"abc\x849\x849\xc1\xc4", "replace", "abc�9�9聊"),
        ("・", "strict", b"\x819\xa79"),
        (b"abc\x842\x80\x80def", "replace", "abc�2��def"),
        (b"abc\x810\x810def", "strict", "abc\x80def"),
        (b"abc\x860\x810def", "replace", "abc�0�0def"),
...
class Test_HZ(multibytecodec_support.TestBase, unittest.TestCase):
    ...
    codectests = (
        ...
        (b"ab~{\x81\x81AD~}cd", "replace", "ab��聊cd"),
        (b"ab~{AD~}cd", "replace", "ab聊cd"),
        (b"ab~{yyAD~}cd", "replace", "ab��聊cd"),
        ("ab~cd", "strict", b"ab~~cd"),
        (b"~{Dc~~:C~}", "strict", None),
        (b"~{Dc~\n:C~}", "strict", None),
    )
