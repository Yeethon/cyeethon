...
class StructTest(unittest.TestCase):
    ...
    def test_new_features(self):
        tests = [
            ("c", b"a", b"a", b"a", 0),
            ("xc", b"a", b"\x00a", b"\x00a", 0),
            ("cx", b"a", b"a\x00", b"a\x00", 0),
            ("s", b"a", b"a", b"a", 0),
            ...
            ("11s", b"helloworld", b"helloworld\x00", b"helloworld\x00", 1),
            (
                "20s",
                b"helloworld",
                (b"helloworld" + (10 * b"\x00")),
                (b"helloworld" + (10 * b"\x00")),
                1,
            ),
            ("b", 7, b"\x07", b"\x07", 0),
            ...
            ("B", 7, b"\x07", b"\x07", 0),
            ("B", 249, b"\xf9", b"\xf9", 0),
            ("h", 700, b"\x02\xbc", b"\xbc\x02", 0),
            ("h", (-700), b"\xfdD", b"D\xfd", 0),
            ("H", 700, b"\x02\xbc", b"\xbc\x02", 0),
            ("H", (65536 - 700), b"\xfdD", b"D\xfd", 0),
            ("i", 70000000, b"\x04,\x1d\x80", b"\x80\x1d,\x04", 0),
            ("i", (-70000000), b"\xfb\xd3\xe2\x80", b"\x80\xe2\xd3\xfb", 0),
            ("I", 70000000, b"\x04,\x1d\x80", b"\x80\x1d,\x04", 0),
            ("I", (4294967296 - 70000000), b"\xfb\xd3\xe2\x80", b"\x80\xe2\xd3\xfb", 0),
            ("l", 70000000, b"\x04,\x1d\x80", b"\x80\x1d,\x04", 0),
            ("l", (-70000000), b"\xfb\xd3\xe2\x80", b"\x80\xe2\xd3\xfb", 0),
            ("L", 70000000, b"\x04,\x1d\x80", b"\x80\x1d,\x04", 0),
            ("L", (4294967296 - 70000000), b"\xfb\xd3\xe2\x80", b"\x80\xe2\xd3\xfb", 0),
            ("f", 2.0, b"@\x00\x00\x00", b"\x00\x00\x00@", 0),
            (
                "d",
                2.0,
            ...
            ("f", (-2.0), b"\xc0\x00\x00\x00", b"\x00\x00\x00\xc0", 0),
            (
                "d",
                (-2.0),
    ...
    def test_boundary_error_message_with_negative_offset(self):
        ...
        with self.assertRaisesRegex(
            struct.error, "no space to pack 4 bytes at offset -2"
        ):
        ...
        with self.assertRaisesRegex(
            struct.error, "not enough data to unpack 4 bytes at offset -2"
        ):
    ...
    def test_boundary_error_message_with_large_offset(self):
        regex1 = (
            (
                ...
                + " bytes for packing 4 bytes at offset "
            )
            + str(sys.maxsize)
        ...
        regex2 = (
            (
                ("unpack_from requires a buffer of at least " + str((sys.maxsize + 4)))
                + " bytes for unpacking 4 bytes at offset "
            )
            + str(sys.maxsize)
        ) + " \\(actual buffer size is 10\\)"
        with self.assertRaisesRegex(struct.error, regex2):
...
class UnpackIteratorTest(unittest.TestCase):
    ...
    def test_half_float(self):
        ...
        format_bits_float__rounding_list = [
            (">e", b"\x00\x01", ((2.0 ** (-25)) + (2.0 ** (-35)))),
            (">e", b"\x00\x00", (2.0 ** (-25))),
            (">e", b"\x00\x00", (2.0 ** (-26))),
            (">e", b"\x03\xff", ((2.0 ** (-14)) - (2.0 ** (-24)))),
            (">e", b"\x03\xff", (((2.0 ** (-14)) - (2.0 ** (-25))) - (2.0 ** (-65)))),
            (">e", b"\x04\x00", ((2.0 ** (-14)) - (2.0 ** (-25)))),
            (">e", b"\x04\x00", (2.0 ** (-14))),
            (">e", b"<\x01", ((1.0 + (2.0 ** (-11))) + (2.0 ** (-16)))),
            (">e", b"<\x00", (1.0 + (2.0 ** (-11)))),
            (">e", b"<\x00", (1.0 + (2.0 ** (-12)))),
            (">e", b"{\xff", 65504),
            (">e", b"{\xff", 65519),
            (">e", b"\x80\x01", ((-(2.0 ** (-25))) - (2.0 ** (-35)))),
            (">e", b"\x80\x00", (-(2.0 ** (-25)))),
            (">e", b"\x80\x00", (-(2.0 ** (-26)))),
            (">e", b"\xbc\x01", (((-1.0) - (2.0 ** (-11))) - (2.0 ** (-16)))),
            (">e", b"\xbc\x00", ((-1.0) - (2.0 ** (-11)))),
            (">e", b"\xbc\x00", ((-1.0) - (2.0 ** (-12)))),
            (">e", b"\xfb\xff", (-65519)),
        ]
