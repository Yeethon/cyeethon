...
class CodecCallbackTest(unittest.TestCase):
    ...
    def test_badandgoodignoreexceptions(self):
        ...
        self.assertEqual(
            codecs.ignore_errors(UnicodeTranslateError("aあb", 1, 2, "ouch")), ("", 2)
        )
    ...
    def test_badandgoodreplaceexceptions(self):
        ...
        self.assertEqual(
            codecs.replace_errors(UnicodeEncodeError("ascii", "aあb", 1, 2, "ouch")),
            ("?", 2),
        )
        self.assertEqual(
    ...
    def test_unencodablereplacement(self):
        ...
        for enc in ("ascii", "iso-8859-1", "iso-8859-15"):
            self.assertRaises(
                UnicodeEncodeError, "䉂".encode, enc, "test.unencreplhandler"
            )
    ...
    def test_decodehelper(self):
        ...
        self.assertRaises(
            UnicodeError, codecs.charmap_decode, b"\xff", "strict", {255: None}
        )
    ...
    def test_encodehelper(self):
        ...
        for err in (
            ...
            self.assertRaises(
                UnicodeError, codecs.charmap_encode, "ÿ", err, {255: None}
            )
