        ...
        self.assertTrue(
            ...
            (
                ...
                % (
                    ...
                    (
                        "%s %s"
                        % (self.locale_time.a_weekday[4], self.locale_time.a_month[4])
                    ),
                )
            ),
        )
...
class CalculationTests(unittest.TestCase):
    ...
    def test_day_of_week_calculation(self):
        ...
        self.assertTrue(
            ...
            (
                "Calculation of day of the week failed; %s != %s"
                % (result.tm_wday, self.time_tuple.tm_wday)
            ),
        )
    ...
    def test_week_of_year_and_day_of_week_calculation(self):
        ...
        test_helper(
            (1917, 12, 31), "Dec 31 on Monday with year starting and ending on Monday"
        )
