...
class BaseXYTestCase(unittest.TestCase):
    ...
    def test_a85encode(self):
        ...
        eq(
            base64.a85encode(b"\x00\x00\x00\x00www.python.org", wrapcol=7, adobe=False),
            b"zGB\\6`E\n-ZP=Df.\n1GEb>",
        )
        eq(
    ...
    def test_b85encode(self):
        ...
        tests = {
            ...
            bytes(
                range(255)
            ): b"009C61O)~M2nh-c3=Iws5D^j+6crX17#SKH9337XAR!_nBqb&%C@Cr{EG;fCFflSSG&MFiI5|2yJUu=?KtV!7L`6nNNJ&adOifNtP*GA-R8>}2SXo+ITwPvYU}0ioWMyV&XlZI|Y;A6DaB*^Tbai%jczJqze0_d@fPsR8goTEOh>41ejE#<ukdcy;l$Dm3n3<ZJoSmMZprN9pq@|{(sHv)}tgWuEu(7hUw6(UkxVgH!yuH4^z`?@9#Kp$P$jQpf%+1cv(9zP<)YaD4*xB0K+}+;a;Njxq<mKk)=;`X~?CtLF@bU8V^!4`l`1$(#{Qdp",
    ...
    def test_a85decode(self):
        ...
        tests = {
            ...
            b"! ! * -'\"\n\t\t9eu\r\n7#  RL\x0bhG$k3[W&.oNg'GVB\"(`=52*$$(B+<_pR,UFcb-n-Vr/1iJ-0JP==1c70M3&s#]4?Ykm5X@_(6q'R884cEH9MJ8X:f1+h<)lt#=BSg3>[:ZC?t!MSA7]@cBPD3sCi+'.E,fo>FEMbNG^4U^I!pHnJ:W<)KS>/9Ll%\"IN/`jYOHG]iPa.Q$R$jD4S=Q7DTV8*TUnsrdW2ZetXKAY/Yd(L?['d?O\\@K2_]Y2%o^qmn*`5Ta:aN;TJbg\"GZd*^:jeCE.%f\\,!5gtgiEi8N\\UjQ5OekiqBum-X60nF?)@o_%qPq\"ad`r;HT": bytes(
                range(255)
            ),
        ...
        for (data, res) in tests.items():
            ...
            eq(
                base64.a85decode(("<~%s~>" % data.decode("ascii")), adobe=True),
                res,
                data,
            )
    ...
    def test_b85decode(self):
        ...
        tests = {
            ...
            b"009C61O)~M2nh-c3=Iws5D^j+6crX17#SKH9337XAR!_nBqb&%C@Cr{EG;fCFflSSG&MFiI5|2yJUu=?KtV!7L`6nNNJ&adOifNtP*GA-R8>}2SXo+ITwPvYU}0ioWMyV&XlZI|Y;A6DaB*^Tbai%jczJqze0_d@fPsR8goTEOh>41ejE#<ukdcy;l$Dm3n3<ZJoSmMZprN9pq@|{(sHv)}tgWuEu(7hUw6(UkxVgH!yuH4^z`?@9#Kp$P$jQpf%+1cv(9zP<)YaD4*xB0K+}+;a;Njxq<mKk)=;`X~?CtLF@bU8V^!4`l`1$(#{Qdp": bytes(
                range(255)
            ),
    ...
    def test_encode_decode(self):
        ...
        self.assertSequenceEqual(
            ...
            (
                ...
                b"b'QWxhZGRpbjpvcGVuIHNlc2FtZQ==\\n'",
                b"b'Aladdin:open sesame'",
            ),
        )
