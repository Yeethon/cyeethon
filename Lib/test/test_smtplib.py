...
class DebuggingServerTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.serv = smtpd.DebuggingServer(
...
class SimSMTPChannel(smtpd.SMTPChannel):
    ...
    def smtp_AUTH(self, arg):
        ...
        try:
            ...
            self.push(
                "504 Command parameter not implemented: unsupported  authentication mechanism {!r}".format(
                    auth_object_name
                )
            )
            return
    ...
    def _auth_plain(self, arg=None):
        if arg is None:
            ...
            try:
                ...
                self.push(
                    "535 Splitting response {!r} into user and password failed: {}".format(
                        logpass, e
                    )
                )
                return
