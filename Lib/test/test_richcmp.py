...
class MiscTest(unittest.TestCase):
    ...
    def test_exception_message(self):
        ...
        tests = [
            ((lambda: (42 < None)), "'<' .* of 'int' and 'NoneType'"),
            ((lambda: (None < 42)), "'<' .* of 'NoneType' and 'int'"),
            ((lambda: (42 > None)), "'>' .* of 'int' and 'NoneType'"),
            ((lambda: ("foo" < None)), "'<' .* of 'str' and 'NoneType'"),
            ((lambda: ("foo" >= 666)), "'>=' .* of 'str' and 'int'"),
            ((lambda: (42 <= None)), "'<=' .* of 'int' and 'NoneType'"),
            ((lambda: (42 >= None)), "'>=' .* of 'int' and 'NoneType'"),
            ((lambda: (42 < [])), "'<' .* of 'int' and 'list'"),
            ((lambda: (() > [])), "'>' .* of 'tuple' and 'list'"),
            ((lambda: (None >= None)), "'>=' .* of 'NoneType' and 'NoneType'"),
            ((lambda: (Spam() < 42)), "'<' .* of 'Spam' and 'int'"),
            ((lambda: (42 < Spam())), "'<' .* of 'int' and 'Spam'"),
            ((lambda: (Spam() <= Spam())), "'<=' .* of 'Spam' and 'Spam'"),
        ]
