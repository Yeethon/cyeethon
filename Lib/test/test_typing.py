...
class CallableTests(BaseTestCase):
    ...
    def test_callable_with_ellipsis(self):
        ...
        self.assertEqual(
            get_type_hints(foo, globals(), locals()), {"a": Callable[(..., T)]}
        )
...
class LiteralTests(BaseTestCase):
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            repr(Literal[(1, True, "foo")]), "typing.Literal[1, True, 'foo']"
        )
    ...
    def test_args(self):
        ...
        self.assertEqual(
            Literal[(1, Literal[2], Literal[(3, 4)])].__args__, (1, 2, 3, 4)
        )
...
class ProtocolTests(BaseTestCase):
    ...
    def test_generic_protocols_special_from_protocol(self):
        ...
        self.assertEqual(
            frozenset(typing._get_protocol_attrs(PG)), frozenset({"x", "meth"})
        )
...
class GenericTests(BaseTestCase):
    ...
    def test_new_repr_complex(self):
        ...
        TS = TypeVar("TS")
        self.assertEqual(
            repr(typing.Mapping[(T, TS)][(TS, T)]), "typing.Mapping[~TS, ~T]"
        )
        self.assertEqual(
    ...
    def test_generic_hashes(self):
        ...
        self.assertEqual(
            mod_generics_cache.B.A[B.A[str]], mod_generics_cache.B.A[B.A[str]]
        )
        ...
        self.assertNotEqual(
            Union[(str, A[str])], Union[(str, mod_generics_cache.A[str])]
        )
        self.assertNotEqual(
    ...
    def test_extended_generic_rules_eq(self):
        ...
        self.assertEqual(
            typing.Iterable[Tuple[(T, T)]][T], typing.Iterable[Tuple[(T, T)]]
        )
        with self.assertRaises(TypeError):
            Tuple[(T, int)][()]
        ...
        self.assertEqual(
            Union[(T, Base)][Union[(Base, Derived)]], Union[(Base, Derived)]
        )
        with self.assertRaises(TypeError):
            Union[(T, int)][1]
    ...
    def test_type_erasure(self):
        ...
        class Node(Generic[T]):
            def __init__(
                self, label: T, left: "Node[T]" = None, right: "Node[T]" = None
            ):
                self.label = label
                self.left = left
                self.right = right
...
class ForwardRefTests(BaseTestCase):
    ...
    def test_callable_forward(self):
        ...
        self.assertEqual(
            get_type_hints(foo, globals(), locals()), {"a": Callable[([T], T)]}
        )
...
class GetTypeHintTests(BaseTestCase):
    ...
    def test_get_type_hints_classes(self):
        ...
        self.assertEqual(
            gth(NoneAndForward), {"parent": NoneAndForward, "meaning": type(None)}
        )
        self.assertEqual(
    ...
    def test_get_type_hints_ClassVar(self):
        self.assertEqual(
            gth(ann_module2.CV, ann_module2.__dict__),
    ...
    def test_get_type_hints_annotated(self):
        ...
        self.assertIs(
            get_type_hints(barfoo3, globals(), locals(), include_extras=True)["x"], BA2
        )
...
class GetUtilitiesTestCase(TestCase):
    ...
    def test_get_args(self):
        ...
        self.assertEqual(get_args(collections.abc.Callable[([], str)]), ([], str))
        self.assertEqual(
            get_args(collections.abc.Callable[([int], str)]),
...
class NamedTupleTests(BaseTestCase):
    ...
    def test_basics(self):
        ...
        self.assertEqual(
            Emp.__annotations__, collections.OrderedDict([("name", str), ("id", int)])
        )
    ...
    def test_annotation_usage(self):
        ...
        self.assertEqual(
            CoolEmployee.__annotations__, collections.OrderedDict(name=str, cool=int)
        )
...
class RETests(BaseTestCase):
    ...
    def test_cannot_subclass(self):
        ...
        self.assertEqual(
            str(ex.exception), "type 're.Match' is not an acceptable base type"
        )
...
class ParamSpecTests(BaseTestCase):
    ...
    def test_var_substitution(self):
        ...
        self.assertEqual(
            C1[([int, str, dict], float)], Callable[([int, str, dict], float)]
        )
    ...
    def test_all_exported_names(self):
        ...
        computed_all = {
            ...
            if (
                ...
                or (
                    (not k.startswith("_"))
                    and (k not in typing.io.__all__)
                    and (k not in typing.re.__all__)
                    and (k not in {"io", "re"})
                    and (not k.endswith(("Meta", "_contra", "_co")))
                    and (not (k.upper() == k))
                    and (getattr(v, "__module__", None) == typing.__name__)
                )
            )
        }
