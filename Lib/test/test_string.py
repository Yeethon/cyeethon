...
class ModuleTest(unittest.TestCase):
    ...
    def test_format_keyword_arguments(self):
        ...
        self.assertEqual(
            fmt.format("-{format_string}-", format_string="test"), "-test-"
        )
    ...
    def test_auto_numbering(self):
        ...
        self.assertEqual(
            fmt.format("foo{1}{num}{1}", None, "bar", num=6),
            "foo{1}{num}{1}".format(None, "bar", num=6),
        )
        self.assertEqual(fmt.format("{:^{}}", "bar", 6), "{:^{}}".format("bar", 6))
        self.assertEqual(
            fmt.format("{:^{}} {}", "bar", 6, "X"), "{:^{}} {}".format("bar", 6, "X")
        )
        self.assertEqual(
            fmt.format("{:^{pad}}{}", "foo", "bar", pad=6),
    ...
    def test_conversion_specifiers(self):
        ...
        self.assertEqual(
            fmt.format("{0!a}", string.ascii_letters),
...
class TestTemplate(unittest.TestCase):
    ...
    def test_SafeTemplate(self):
        ...
        eq(
            s.safe_substitute(dict(what="ham", meal="dinner")),
            "$who likes ham for dinner",
        )
        eq(s.safe_substitute(dict(who="tim", what="ham")), "tim likes ham for ${meal}")
        eq(
            s.safe_substitute(dict(who="tim", what="ham", meal="dinner")),
    ...
    def test_keyword_arguments(self):
        ...
        eq(
            s.substitute(dict(who="fred", what="kung pao"), who="tim", what="ham"),
            "tim likes ham",
        )
    ...
    def test_keyword_arguments_safe(self):
        ...
        eq(
            s.safe_substitute(dict(who="fred", what="kung pao"), who="tim", what="ham"),
            "tim likes ham",
        )
        s = Template("the mapping is $mapping")
