...
def parse_args():
    ...
    parser.add_argument(
        "-i",
        "--input",
        help="Test names produced by --list-tests written into a file. If not set, run --list-tests",
    )
...
def main():
    ...
    print(
        (
            "Bisection will stop when getting %s or less tests (-n/--max-tests option), or after %s iterations (-N/--max-iter option)"
