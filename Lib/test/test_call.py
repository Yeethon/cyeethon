...
class TestCallingConventions(unittest.TestCase):
    ...
    def test_varargs(self):
        self.assertEqual(
            self.obj.meth_varargs(1, 2, 3), (self.expected_self, (1, 2, 3))
        )
    ...
    def test_varargs_error_kw(self):
        ...
        self.assertRaisesRegex(TypeError, msg, (lambda: self.obj.meth_varargs(k=1)))
    ...
    def test_o_error_two_args(self):
        ...
        self.assertRaisesRegex(TypeError, msg, (lambda: self.obj.meth_o(1, 2)))

    def test_o_error_ext(self):
        msg = "meth_o\\(\\) takes exactly one argument \\(3 given\\)"
        self.assertRaisesRegex(TypeError, msg, (lambda: self.obj.meth_o(*(1, 2, 3))))

    def test_o_error_kw(self):
        msg = "meth_o\\(\\) takes no keyword arguments"
        self.assertRaisesRegex(TypeError, msg, (lambda: self.obj.meth_o(k=1)))
    ...
    def test_noargs_error_arg2(self):
        ...
        self.assertRaisesRegex(TypeError, msg, (lambda: self.obj.meth_noargs(1, 2)))
    ...
    def test_fastcall(self):
        self.assertEqual(
            self.obj.meth_fastcall(1, 2, 3), (self.expected_self, (1, 2, 3))
        )
    ...
    def test_fastcall_error_kw(self):
        ...
        self.assertRaisesRegex(TypeError, msg, (lambda: self.obj.meth_fastcall(k=1)))
...
class TestPEP590(unittest.TestCase):
    def test_method_descriptor_flag(self):
        ...
        self.assertFalse(
            (MethodDescriptorHeap.__flags__ & Py_TPFLAGS_METHOD_DESCRIPTOR)
        )
