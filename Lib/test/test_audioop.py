...
datas = {
    1: b"\x00\x12E\xbb\x7f\x80\xff",
    2: packs[2](0, 4660, 17767, (-17767), 32767, (-32768), (-1)),
    3: packs[3](0, 1193046, 4548489, (-4548489), 8388607, (-8388608), (-1)),
    4: packs[4](
        0, 305419896, 1164413355, (-1164413355), 2147483647, (-2147483648), (-1)
    ),
}
...
class TestAudioop(unittest.TestCase):
    ...
    def test_minmax(self):
        for w in (1, 2, 3, 4):
            ...
            self.assertEqual(
                audioop.minmax(bytearray(), w), (2147483647, (-2147483648))
            )
            self.assertEqual(
                audioop.minmax(memoryview(b""), w), (2147483647, (-2147483648))
            )
            p = packs[w]
    ...
    def test_avg(self):
        ...
        self.assertEqual(
            audioop.avg(packs[4]((-1342177280), (-1879048192)), 4), (-1610612736)
        )
    ...
    def test_add(self):
        for w in (1, 2, 3, 4):
            ...
            self.assertEqual(
                audioop.add(datas[w], (b"\x00" * len(datas[w])), w), datas[w]
            )
        self.assertEqual(
            audioop.add(datas[1], datas[1], 1), b"\x00$\x7f\x80\x7f\x80\xfe"
        )
        self.assertEqual(
            audioop.add(datas[2], datas[2], 2),
            packs[2](0, 9320, 32767, (-32768), 32767, (-32768), (-2)),
        )
        self.assertEqual(
            audioop.add(datas[3], datas[3], 3),
            packs[3](0, 2386092, 8388607, (-8388608), 8388607, (-8388608), (-2)),
        )
        self.assertEqual(
            audioop.add(datas[4], datas[4], 4),
            packs[4](
                0, 610839792, 2147483647, (-2147483648), 2147483647, (-2147483648), (-2)
            ),
        )
    ...
    def test_bias(self):
        ...
        self.assertEqual(
            audioop.bias(datas[1], 1, 2147483647), b"\xff\x11D\xba~\x7f\xfe"
        )
        ...
        self.assertEqual(
            audioop.bias(datas[2], 2, 2147483647),
            packs[2]((-1), 4659, 17766, (-17768), 32766, 32767, (-2)),
        )
        ...
        self.assertEqual(
            ...
            packs[4](
                1, 305419897, 1164413356, (-1164413354), (-2147483648), (-2147483647), 0
            ),
        )
        self.assertEqual(
            audioop.bias(datas[4], 4, (-1)),
            packs[4](
                (-1), 305419895, 1164413354, (-1164413356), 2147483646, 2147483647, (-2)
            ),
        )
        self.assertEqual(
    ...
    def test_lin2lin(self):
        ...
        self.assertEqual(
            ...
            packs[2](0, 4608, 17664, (-17664), 32512, (-32768), (-256)),
        )
        self.assertEqual(
            audioop.lin2lin(datas[1], 1, 3),
            packs[3](0, 1179648, 4521984, (-4521984), 8323072, (-8388608), (-65536)),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            packs[3](0, 1192960, 4548352, (-4548352), 8388352, (-8388608), (-256)),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            packs[2](0, 4660, 17767, (-17768), 32767, (-32768), (-1)),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            packs[3](0, 1193046, 4548489, (-4548490), 8388607, (-8388608), (-1)),
        )
    ...
    def test_adpcm2lin(self):
        ...
        for w in (1, 2, 3, 4):
            self.assertEqual(
                audioop.adpcm2lin((b"\x00" * 5), w, None),
                (((b"\x00" * w) * 10), (0, 0)),
            )
    ...
    def test_lin2adpcm(self):
        ...
        for w in (1, 2, 3, 4):
            self.assertEqual(
                audioop.lin2adpcm(((b"\x00" * w) * 10), w, None),
                ((b"\x00" * 5), (0, 0)),
            )
    ...
    def test_lin2alaw(self):
        ...
        self.assertEqual(
            audioop.lin2alaw(bytearray(datas[1]), 1), b"\xd5\x87\xa4$\xaa*Z"
        )
        self.assertEqual(
            audioop.lin2alaw(memoryview(datas[1]), 1), b"\xd5\x87\xa4$\xaa*Z"
        )
        for w in (2, 3, 4):
    ...
    def test_lin2ulaw(self):
        ...
        self.assertEqual(
            audioop.lin2ulaw(bytearray(datas[1]), 1), b"\xff\xad\x8e\x0e\x80\x00g"
        )
        self.assertEqual(
            audioop.lin2ulaw(memoryview(datas[1]), 1), b"\xff\xad\x8e\x0e\x80\x00g"
        )
        for w in (2, 3, 4):
            self.assertEqual(
                audioop.lin2ulaw(datas[w], w), b"\xff\xad\x8e\x0e\x80\x00~"
            )
    ...
    def test_ratecv(self):
        for w in (1, 2, 3, 4):
            ...
            self.assertEqual(
                audioop.ratecv(b"", w, 5, 8000, 8000, None),
                (b"", ((-1), (((0, 0),) * 5))),
            )
            self.assertEqual(
        ...
        expected = {
            1: packs[1](0, 13, 55, (-38), 85, (-75), (-20)),
            2: packs[2](0, 3495, 14199, (-9776), 22131, (-19044), (-4762)),
            3: packs[3](
                0, 894784, 3635062, (-2502602), 5665804, (-4875005), (-1218752)
            ),
            4: packs[4](
                0,
                229064922,
    ...
    def test_byteswap(self):
        swapped_datas = {
            ...
            4: packs[4](0, 2018915346, (-1417058491), 1433835706, (-129), 128, (-1)),
        }
        for w in (1, 2, 3, 4):
