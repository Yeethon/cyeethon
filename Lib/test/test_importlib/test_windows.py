...
class WindowsBootstrapPathTests(unittest.TestCase):
    ...
    def test_path_join(self):
        self.check_join("C:\\A\\B", "C:\\", "A", "B")
        self.check_join("C:\\A\\B", "D:\\", "D", "C:\\", "A", "B")
        self.check_join("C:\\A\\B", "C:\\", "A", "C:B")
        self.check_join("C:\\A\\B", "C:\\", "A\\B")
        self.check_join("C:\\A\\B", "C:\\A\\B")
        self.check_join("D:A", "D:", "A")
        self.check_join("D:A", "C:\\B\\C", "D:", "A")
        self.check_join("D:A", "C:\\B\\C", "D:A")
        self.check_join("A\\B\\C", "A", "B", "C")
        self.check_join("A\\B\\C", "A", "B\\C")
        self.check_join("A\\B/C", "A", "B/C")
        self.check_join("A\\B\\C", "A/", "B\\", "C")
        self.check_join("A\\../C", "A", "../C")
        self.check_join("A.\\.\\B", "A.", ".", "B")
        self.check_join(
            "\\\\Server\\Share\\A\\B\\C", "\\\\Server\\Share", "A", "B", "C"
        )
        self.check_join(
            "\\\\Server\\Share\\A\\B\\C", "\\\\Server\\Share", "D", "\\A", "B", "C"
        )
        self.check_join(
            "\\\\Server\\Share\\A\\B\\C",
            "\\\\Server2\\Share2",
