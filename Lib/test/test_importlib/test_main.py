...
class ImportTests(fixtures.DistInfoPkg, unittest.TestCase):
    ...
    def test_resolve_without_attr(self):
        ep = EntryPoint(name="ep", value="importlib.metadata", group="grp")
...
class TestEntryPoints(unittest.TestCase):
    ...
    def test_sortable(self):
        sorted([EntryPoint("b", "val", "group"), EntryPoint("a", "val", "group")])
...
class FileSystem(
    ...
    def test_unicode_dir_on_sys_path(self):
        fixtures.build_files({self.unicode_filename(): {}}, prefix=self.site_dir)
        list(distributions())
