...
class ModuleSpecTests:
    ...
    def test_inequality_incomplete(self):
        other = type(sys.implementation)(name=self.name, loader=self.loader)
        self.assertNotEqual(self.spec, other)
...
class ModuleReprTests:
    ...
    def test_module___loader___module_repr_bad(self):
        ...
        self.module.__loader__ = Loader()
        modrepr = self.bootstrap._module_repr(self.module)
        self.assertEqual(modrepr, "<module {!r} (<TestLoader object>)>".format("spam"))
    ...
    def test_module___spec___location(self):
        ...
        self.module.__spec__ = self.spec
        modrepr = self.bootstrap._module_repr(self.module)
        self.assertEqual(modrepr, "<module {!r} from {!r}>".format("spam", location))
    ...
    def test_module_with_file(self):
        ...
        modrepr = self.bootstrap._module_repr(self.module)
        self.assertEqual(modrepr, "<module {!r} from {!r}>".format("spam", filename))
...
(Frozen_ModuleReprTests, Source_ModuleReprTests) = test_util.test_both(
    ModuleReprTests, init=init, util=util, machinery=machinery
)
