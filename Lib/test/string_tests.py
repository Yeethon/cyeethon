...
class BaseTest:
    ...
    def test_count(self):
        ...
        for i in teststrings:
            ...
            for j in teststrings:
                ...
                if j:
                    (r2, rem) = divmod(
                        (n - len(i.replace(j, self.fixtype("")))), len(j)
                    )
                else:
                    (r2, rem) = ((len(i) + 1), 0)
                if rem or (r1 != r2):
    ...
    def test_split(self):
        ...
        self.checkequal(
            ["a", "b", "c", "d"], "a|b|c|d", "split", "|", (sys.maxsize - 2)
        )
        self.checkequal(["a|b|c|d"], "a|b|c|d", "split", "|", 0)
        self.checkequal(["a", "", "b||c||d"], "a||b||c||d", "split", "|", 2)
        ...
        self.checkequal(
            ((["a"] * 15) + ["a|a|a|a|a"]), ("a|" * 20)[:(-1)], "split", "|", 15
        )
        self.checkequal(["a", "b", "c", "d"], "a//b//c//d", "split", "//")
        self.checkequal(["a", "b//c//d"], "a//b//c//d", "split", "//", 1)
        self.checkequal(["a", "b", "c//d"], "a//b//c//d", "split", "//", 2)
    ...
    def test_rsplit(self):
        ...
        self.checkequal(
            (["a|a|a|a|a"] + (["a"] * 15)), ("a|" * 20)[:(-1)], "rsplit", "|", 15
        )
        self.checkequal(["a", "b", "c", "d"], "a//b//c//d", "rsplit", "//")
        self.checkequal(["a//b//c", "d"], "a//b//c//d", "rsplit", "//", 1)
        self.checkequal(["a//b", "c", "d"], "a//b//c//d", "rsplit", "//", 2)
    ...
    def test_additional_split(self):
        ...
        self.checkequal(
            ["a", "b", "c", "d"], "a b c d", "split", None, (sys.maxsize - 1)
        )
...
class MixinStrUnicodeUserStringTest:
    ...
    def test_formatting(self):
        ...
        self.checkraises(
            OverflowError, "%.*f", "__mod__", ((sys.maxsize + 1), (1.0 / 7))
        )
    ...
    def test_find_etc_raise_correct_error_messages(self):
        ...
        self.assertRaisesRegex(
            TypeError, "^startswith\\(", s.startswith, x, None, None, None
        )
        self.assertRaisesRegex(
            TypeError, "^endswith\\(", s.endswith, x, None, None, None
        )
