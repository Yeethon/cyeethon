...
class TestCase(unittest.TestCase):
    ...
    def test_helper_asdict_namedtuple(self):
        ...
        d = asdict(c)
        self.assertEqual(
            d, {"x": "outer", "y": T(1, {"x": "inner", "y": T(11, 12, 13)}, 2)}
        )
        d = asdict(c, dict_factory=OrderedDict)
        self.assertEqual(
            d, {"x": "outer", "y": T(1, {"x": "inner", "y": T(11, 12, 13)}, 2)}
...
class TestHash(unittest.TestCase):
    ...
    def test_hash_rules(self):
        ...
        for (
            case,
            (unsafe_hash, eq, frozen, res_no_defined_hash, res_defined_hash),
        ) in enumerate(
            [
                (False, False, False, "", ""),
                (False, False, True, "", ""),
...
class TestReplace(unittest.TestCase):
    ...
    def test_recursive_repr_indirection(self):
        ...
        self.assertEqual(
            repr(c),
            "TestReplace.test_recursive_repr_indirection.<locals>.C(f=TestReplace.test_recursive_repr_indirection.<locals>.D(f=...))",
        )
    ...
    def test_recursive_repr_indirection_two(self):
        ...
        self.assertEqual(
            repr(c),
            "TestReplace.test_recursive_repr_indirection_two.<locals>.C(f=TestReplace.test_recursive_repr_indirection_two.<locals>.D(f=TestReplace.test_recursive_repr_indirection_two.<locals>.E(f=...)))",
        )
    ...
    def test_recursive_repr_misc_attrs(self):
        ...
        c.f = c
        self.assertEqual(
            repr(c), "TestReplace.test_recursive_repr_misc_attrs.<locals>.C(f=..., g=1)"
        )
