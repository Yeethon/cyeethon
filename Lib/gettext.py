...
class NullTranslations:
        ...
        if self._fallback:
            with warnings.catch_warnings():
                warnings.filterwarnings(
                    "ignore", ".*\\blgettext\\b.*", DeprecationWarning
                )
    ...
    def lngettext(self, msgid1, msgid2, n):
        ...
        if self._fallback:
            with warnings.catch_warnings():
                warnings.filterwarnings(
                    "ignore", ".*\\blngettext\\b.*", DeprecationWarning
                )
    ...
    for mofile in mofiles:
        ...
        if codeset is not _unspecified:
            ...
            if codeset:
                with warnings.catch_warnings():
                    warnings.filterwarnings(
                        "ignore", ".*\\bset_output_charset\\b.*", DeprecationWarning
                    )
...
def ldgettext(domain, message):
    ...
    try:
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore", ".*\\bparameter codeset\\b.*", DeprecationWarning
            )
