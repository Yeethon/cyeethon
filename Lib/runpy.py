...
def _get_module_details(mod_name, error=ImportError):
    ...
    if pkg_name:
        ...
        if (existing is not None) and (not hasattr(existing, "__path__")):
            ...
            msg = "{mod_name!r} found in sys.modules after import of package {pkg_name!r}, but prior to execution of {mod_name!r}; this may result in unpredictable behaviour".format(
                mod_name=mod_name, pkg_name=pkg_name
            )
