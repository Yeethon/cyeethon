...
AVAILABLE_KEYS = (
    (((ALPHANUM_KEYS + PUNCTUATION_KEYS) + FUNCTION_KEYS) + WHITESPACE_KEYS) + EDIT_KEYS
) + MOVE_KEYS
...
class GetKeysDialog(Toplevel):
    ...
    def create_widgets(self):
        ...
        advanced_title = Label(
            ...
            justify="left",
            text=(
                f"""Enter new binding(s) for '{self.action}' :
"""
        ...
        self.button_level = Button(
            frame, command=self.toggle_level, text="<< Basic Key Binding Entry"
        )
