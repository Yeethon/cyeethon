...
class ModuleFunctionTest(unittest.TestCase):
    ...
    def test_file_line_helper(self, mock_open):
        ...
        test_lines = (
            ('foo file "testfile1", line 42, bar', ("testfile1", 42)),
            ("foo testfile2(21) bar", ("testfile2", 21)),
            ("  testfile3  : 42: foo bar\\n", ("  testfile3  ", 42)),
            ("foo testfile4.py :1: ", ("foo testfile4.py ", 1)),
            ("testfile5: ᧔᧒: ", ("testfile5", 42)),
            ("testfile6: 42", None),
            ("testfile7 42 text", None),
        )
