...
class MiscTest(AbstractTkTest, unittest.TestCase):
    ...
    def test_winfo_rgb(self):
        ...
        self.assertEqual(rgb("#F0F"), (65535, 0, 65535))
        self.assertEqual(rgb("#4a3c8c"), (19018, 15420, 35980))
        self.assertEqual(rgb("#dede14143939"), (57054, 5140, 14649))
        with self.assertRaises(tkinter.TclError):
            rgb("#123456789a")
        with self.assertRaises(tkinter.TclError):
            rgb((111, 78, 55))
    ...
    def test_event_repr(self):
        ...
        self.assertEqual(
            repr(e),
            "<Configure event send_event=True state=Shift|Control|Button3|0x30000 keysym=Key-A keycode=65 char='A' num=3 delta=-1 focus=True x=10 y=20 width=300 height=200>",
        )
