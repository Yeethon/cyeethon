...
class ComboboxTest(EntryTest, unittest.TestCase):
    ...
    def _show_drop_down_listbox(self):
        ...
        (x, y) = ((width - 5), 5)
        self.assertRegex(self.combo.identify(x, y), ".*downarrow\\Z")
...
class SpinboxTest(EntryTest, unittest.TestCase):
    ...
    def _click_increment_arrow(self):
        ...
        x = width - 5
        y = (height // 2) - 5
        self.assertRegex(self.spin.identify(x, y), ".*uparrow\\Z")
    ...
    def _click_decrement_arrow(self):
        ...
        x = width - 5
        y = (height // 2) + 4
        self.assertRegex(self.spin.identify(x, y), ".*downarrow\\Z")
        self.spin.event_generate("<ButtonPress-1>", x=x, y=y)
        self.spin.event_generate("<ButtonRelease-1>", x=x, y=y)
        self.spin.update_idletasks()
    ...
    def test_configure_values(self):
        self.assertEqual(self.spin["values"], (() if (tcl_version < (8, 5)) else ""))
        self.checkParam(
            self.spin,
            "values",
            "mon tue wed thur",
...
class TreeviewTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_selection(self):
        ...
        self.assertEqual(self.tv.selection(), ("bytesâ\x82¬",))
