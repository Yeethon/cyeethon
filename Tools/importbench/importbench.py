...
def main(import_, options):
    ...
    if prev_results:
        ...
        for benchmark in benchmarks:
            ...
            result = "{:,d} vs. {:,d} ({:%})".format(
                new_result, old_result, (new_result / old_result)
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="use the built-in __import__",
    )
    parser.add_argument(
        "-r",
        "--read",
        ...
        help="file to read benchmark data from to compare against",
    )
    parser.add_argument(
        "-w",
        "--write",
