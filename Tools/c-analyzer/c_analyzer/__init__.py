from c_parser import parse_files as _parse_files
from c_parser.info import KIND, TypeDeclaration, resolve_parsed
from c_parser.match import filter_by_kind, group_by_kinds
from . import analyze as _analyze, datafiles as _datafiles
...
def analyze_decls(
    decls, known, *, analyze_resolved=None, handle_unresolved=True, relroot=None
):
