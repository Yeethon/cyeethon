...
BASE_COLUMNS = ["filename", "funcname", "name", "kind"]
END_COLUMNS = {"parsed": "data", "decls": "declaration"}
...
def _render_known_decl(decl, *, _columns="filename parent name kind data".split()):
