...
from . import errors as _errors, get_preprocessor as _get_preprocessor
...
def _iter_preprocessed(filename, *, get_preprocessor, match_kind=None, pure=False):
...
def _cli_preprocess(parser, excluded=None, **prepr_kwargs):
    ...
    return [process_kinds, process_common, process_files]
