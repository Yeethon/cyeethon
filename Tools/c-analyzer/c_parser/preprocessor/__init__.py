...
from ..source import resolve as _resolve_source, good_file as _good_file
from . import errors as _errors
from . import pure as _pure, gcc as _gcc

logger = logging.getLogger(__name__)


def preprocess(
    source, *, incldirs=None, macros=None, samefiles=None, filename=None, tool=True
):
    ...
    def get_file_preprocessor(filename):
        ...
        def preprocess(**kwargs):
            ...
            if file_incldirs and ("incldirs" not in kwargs):
                kwargs["incldirs"] = [
                    v for (v,) in _resolve_file_values(filename, file_incldirs)
                ]
