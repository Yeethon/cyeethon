...
from .preprocessor.__main__ import add_common_cli as add_preprocessor_cli
...
FORMATS = {"raw": fmt_raw, "summary": fmt_summary, "full": fmt_full}
...
def _cli_parse(parser, excluded=None, **prepr_kwargs):
    ...
    return [process_output, process_kinds, process_preprocessor, process_files]
...
COMMANDS = {
    "parse": ("parse the given C source & header files", [_cli_parse], cmd_parse),
    "data": ("check/manage local data (e.g. excludes, macros)", [_cli_data], cmd_data),
}
