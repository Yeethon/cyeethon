...
class TexinfoParser:
    ...
    FN_ID_PATTERN = "(%(id)s)"
    FN_SOURCE_PATTERN = (
        '<A NAME=footnoteref%(id)s HREF="#footnotetext%(id)s">' + FN_ID_PATTERN
    ) + "</A>"
    FN_TARGET_PATTERN = (
        '<A NAME=footnotetext%(id)s HREF="#footnoteref%(id)s">' + FN_ID_PATTERN
    ) + "</A>\n%(text)s<P>\n"
    FN_HEADER = (
...
class TexinfoParserHTML3(TexinfoParser):
    ...
    FN_ID_PATTERN = "[%(id)s]"
    FN_SOURCE_PATTERN = (
        '<A ID=footnoteref%(id)s HREF="#footnotetext%(id)s">' + FN_ID_PATTERN
    ) + "</A>"
    FN_TARGET_PATTERN = (
