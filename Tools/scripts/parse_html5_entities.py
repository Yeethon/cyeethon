...
if __name__ == "__main__":
    ...
    if "--create" in sys.argv:
        print(
            "# map the HTML5 named character references to the equivalent Unicode character(s)"
        )
        ...
        print(
            'Run "./python {0} --patch" to update Lib/html/entities.html or "./python {0} --create" to see the generated dictionary.'.format(
                __file__
            )
        )
